                    ...
                    <div class="nk-cart-dropdown">
                        ...
                        <div class="nk-widget-post">
                            ...
                            <h3 class="nk-post-title">
                                ...
                                <a href="store-product.php">In all revolutions of</a>
                            </h3>
                        ...
                        <div class="nk-widget-post">
                            ...
                            <h3 class="nk-post-title">
                                <a href="#" class="nk-cart-remove-item"><span class="ion-android-close"></span></a>
                                <a href="store-product.php">With what mingled joy</a>
                            </h3>
                            <div class="nk-gap-1"></div>
...
<!-- END: Top Contacts -->
    ...
    <nav class="nk-navbar nk-navbar-top nk-navbar-sticky nk-navbar-autohide">
        <div class="container">
            <div class="nk-nav-table">
                ...
                <a href="index.php" class="nk-nav-logo">
                    <img src="src/assets/images/logo.png" alt="GoodGames" width="199">
                </a>
        ...
        <li>
            <a href="tournaments-teammate.php">
                Teammate
...
<div id="nk-nav-mobile" class="nk-navbar nk-navbar-side nk-navbar-right-side nk-navbar-overlay-content d-lg-none">
    <div class="nano">
        <div class="nano-content">
            <a href="index.php" class="nk-nav-logo">
                <img src="src/assets/images/logo.png" alt="" width="120">
            </a>
...
<div class="container">
    ...
    <div class="row vertical-gap">
        ...
        <div class="col-lg-6">
            <div class="nk-product-cat-2">
                <a class="nk-product-image" href="store-product.php">
                    <img src="src/assets/images/product-1-md.jpg" alt="So saying he unbuckled">
                </a>
        ...
        <div class="col-lg-6">
            <div class="nk-product-cat-2">
                <a class="nk-product-image" href="store-product.php">
                    <img src="src/assets/images/product-2-md.jpg" alt="However, I have reason">
                </a>
                <div class="nk-product-cont">
        ...
        <div class="col-lg-6">
            <div class="nk-product-cat-2">
                <a class="nk-product-image" href="store-product.php">
                    <img src="src/assets/images/product-3-md.jpg" alt="It was some time before">
                </a>
                <div class="nk-product-cont">
        ...
        <div class="col-lg-6">
            <div class="nk-product-cat-2">
                <a class="nk-product-image" href="store-product.php">
                    <img src="src/assets/images/product-4-md.jpg" alt="She was bouncing">
                </a>
                <div class="nk-product-cont">
        ...
        <div class="col-lg-6">
            <div class="nk-product-cat-2">
                <a class="nk-product-image" href="store-product.php">
                    <img src="src/assets/images/product-5-md.jpg" alt="In all revolutions of">
                </a>
                <div class="nk-product-cont">
        ...
        <div class="col-lg-6">
            <div class="nk-product-cat-2">
                <a class="nk-product-image" href="store-product.php">
                    <img src="src/assets/images/product-6-md.jpg" alt="Just then her head ">
                </a>
                <div class="nk-product-cont">
        ...
        <div class="col-lg-6">
            <div class="nk-product-cat-2">
                <a class="nk-product-image" href="store-product.php">
                    <img src="src/assets/images/product-11-md.jpg" alt="She gave my mother">
                </a>
                <div class="nk-product-cont">
        ...
        <div class="col-lg-6">
            <div class="nk-product-cat-2">
                <a class="nk-product-image" href="store-product.php">
                    <img src="src/assets/images/product-12-md.jpg" alt="A hundred thousand">
                </a>
                <div class="nk-product-cont">
        ...
        <div class="col-lg-6">
            <div class="nk-product-cat-2">
                <a class="nk-product-image" href="store-product.php">
                    <img src="src/assets/images/product-13-md.jpg" alt="So saying he unbuckled">
                </a>
                <div class="nk-product-cont">
                    <h3 class="nk-product-title h5"><a href="store-product.php">So saying he unbuckled</a></h3>
                    <div class="nk-gap-1"></div>
        ...
        <div class="col-lg-6">
            <div class="nk-product-cat-2">
                <a class="nk-product-image" href="store-product.php">
                    <img src="src/assets/images/product-14-md.jpg" alt="However, I have reason">
                </a>
                <div class="nk-product-cont">
                    <h3 class="nk-product-title h5"><a href="store-product.php">However, I have reason</a></h3>
                    <div class="nk-gap-1"></div>
        ...
        <div class="col-lg-6">
            <div class="nk-product-cat-2">
                <a class="nk-product-image" href="store-product.php">
                    <img src="src/assets/images/product-15-md.jpg" alt="At first, for some time">
                </a>
                <div class="nk-product-cont">
        ...
        <div class="col-lg-6">
            <div class="nk-product-cat-2">
                <a class="nk-product-image" href="store-product.php">
                    <img src="src/assets/images/product-16-md.jpg" alt="When the last &#39;natural&#39;">
                </a>
                <div class="nk-product-cont">
