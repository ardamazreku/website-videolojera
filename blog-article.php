            ...
            <div class="nk-blog-post nk-blog-post-single">
                ...
                <div class="nk-post-text mt-0">
                    <div class="nk-post-img">
                        <img src="src/assets/images/post-2.jpg" alt="Grab your sword and fight the Horde">
                    </div>
                    <div class="nk-gap-1"></div>
...
<img class="float-left mt-0" src="src/assets/images/post-inner-img.jpg" alt="">
...
<p>This sounded nonsense to Alice, so she said nothing, but set off at once toward the Red Queen. To her surprise, she lost sight of her in a moment, and found herself walking in at the front-door again. For some minutes Alice stood without speaking, looking out in all directions over the country - and a most curious country it was.</p>
                ...
                <div class="nk-comments">
                    ...
                    <div class="nk-comment">
                        ...
                        <div class="nk-comment">
                            <div class="nk-comment-meta">
                                <img src="src/assets/images/avatar-1.jpg" alt="Hitman" class="rounded-circle" width="35"> by <a href="#">Hitman</a> in 20 September, 2018
                                <a href="#" class="nk-btn nk-btn-rounded nk-btn-color-dark-3 float-right">Reply</a>
                            </div>
                            <div class="nk-comment-text">
                    ...
                    <div class="nk-comment">
                        <div class="nk-comment-meta">
                            <img src="src/assets/images/avatar-3.jpg" alt="Wolfenstein" class="rounded-circle" width="35"> by <a href="#">Wolfenstein</a> in 21 September, 2018
                            <a href="#" class="nk-btn nk-btn-rounded nk-btn-color-dark-3 float-right">Reply</a>
                        </div>
                        <div class="nk-comment-text">
