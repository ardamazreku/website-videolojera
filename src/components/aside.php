<div class="col-lg-4">
    <aside class="nk-sidebar nk-sidebar-right nk-sidebar-sticky">
        ...
        <div class="nk-widget nk-widget-highlighted">
            <h4 class="nk-widget-title"><span><span class="text-main-1">Latest</span> Trailer </span></h4>
            <div class="nk-widget-content">
                <div class="nk-plain-video" data-video="https://www.youtube.com/watch?v=0iUeDo5p5Pw&ab_channel=IGN"></div>
            </div>
        </div>
        <div class="nk-widget nk-widget-highlighted">
