            ...
            <div class="nk-blog-grid">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="nk-blog-post">
                            <a href="blog-article.php" class="nk-post-img">
                                <img src="src/assets/images/post-1-mid.jpg" alt="Smell magic in the air. Or maybe barbecue">
                            ...
                            <div class="nk-post-by">
                                <img src="src/assets/images/avatar-1.jpg" alt="Hitman" class="rounded-circle" width="35"> by <a href="#">Hitman</a> in Sep 18, 2018
                            </div>
                            <div class="nk-gap"></div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="nk-blog-post">
                            <a href="blog-article.php" class="nk-post-img">
                                <img src="src/assets/images/post-2-mid.jpg" alt="Grab your sword and fight the Horde">
                            ...
                            <div class="nk-post-by">
                                <img src="src/assets/images/avatar-2.jpg" alt="Witch Murder" class="rounded-circle" width="35"> by <a href="#">Witch Murder</a> in Sep 5, 2018
                            </div>
                            <div class="nk-gap"></div>
                            <div class="nk-post-text">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="nk-blog-post">
                            <a href="blog-article.php" class="nk-post-img">
                                <img src="src/assets/images/post-3-mid.jpg" alt="We found a witch! May we burn her?">
                                <span class="nk-post-comments-count">7</span>
                            </a>
                            <div class="nk-gap"></div>
                            <h2 class="nk-post-title h4"><a href="blog-article.php">We found a witch! May we burn her?</a></h2>
                            <div class="nk-post-by">
                                <img src="src/assets/images/avatar-3.jpg" alt="Wolfenstein" class="rounded-circle" width="35"> by <a href="#">Wolfenstein</a> in Aug 27, 2018
                            </div>
                            <div class="nk-gap"></div>
                            <div class="nk-post-text">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="nk-blog-post">
                            <a href="blog-article.php" class="nk-post-img">
                                <img src="src/assets/images/post-4-mid.jpg" alt="For good, too though, in consequence">
                            ...
                            <div class="nk-post-by">
                                <img src="src/assets/images/avatar-1.jpg" alt="Hitman" class="rounded-circle" width="35"> by <a href="#">Hitman</a> in Aug 14, 2018
                            </div>
                            <div class="nk-gap"></div>
                            <div class="nk-post-text">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="nk-blog-post">
                            ...
                            <div class="nk-post-by">
                                <img src="src/assets/images/avatar-2.jpg" alt="Witch Murder" class="rounded-circle" width="35"> by <a href="#">Witch Murder</a> in Jul 3, 2018
                            </div>
                            <div class="nk-gap"></div>
                            <div class="nk-post-text">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="nk-blog-post">
                            <a href="blog-article.php" class="nk-post-img">
                                <img src="src/assets/images/post-9-mid.jpg" alt="He made his passenger captain of one">
                                <span class="nk-post-comments-count">0</span>
                            </a>
                            <div class="nk-gap"></div>
                            <h2 class="nk-post-title h4"><a href="blog-article.php">He made his passenger captain of one</a></h2>
                            <div class="nk-post-by">
                                <img src="src/assets/images/avatar-1.jpg" alt="Hitman" class="rounded-circle" width="35"> by <a href="#">Hitman</a> in Jul 3, 2018
                            </div>
                            <div class="nk-gap"></div>
                            <div class="nk-post-text">
                                <p>Just then her head struck against the roof of the hall: in fact she was now more than nine feet high, and she at once took up the little golden key and hurried off to the garden door...</p>
...
<div class="nk-gap-2"></div>
    ...
    <img class="nk-page-background-top" src="src/assets/images/bg-top-2.png" alt="">
