...
<div class="container">
    ...
    <div class="nk-image-slider" data-autoplay="8000">
        ...
        <div class="nk-image-slider-item">
            <img src="src/assets/images/slide-4.jpg" alt="" class="nk-image-slider-img" data-thumb="src/assets/images/slide-4-thumb.jpg">
            <div class="nk-image-slider-content">
                    <h3 class="h4">At length one of them called out in a clear</h3>
                    <p class="text-white">TJust then her head struck against the roof of the hall: in fact she was now more than nine feet highsrc.</p>
                    <a href="#" class="nk-btn nk-btn-rounded nk-btn-color-white nk-btn-hover-color-main-1">Read More</a>
            </div>
        </div>
        
        <div class="nk-image-slider-item">
            <img src="src/assets/images/slide-5.jpg" alt="" class="nk-image-slider-img" data-thumb="src/assets/images/slide-5-thumb.jpg">
            <div class="nk-image-slider-content">
                    ...
                    <p class="text-white">My mother was so much worse that Peggotty, coming in with the teaboard and candles, and seeing at a glance how ill she was, - as Miss Betsey might have done sooner if there had been light enough, - conveyed her upstairs to her own room with all speed; and immediately dispatched Ham Peggotty, her nephew, who had been for some days past secreted in the housesrc.</p>
                    <a href="#" class="nk-btn nk-btn-rounded nk-btn-color-white nk-btn-hover-color-main-1">Read More</a>
            </div>
        </div>
    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="nk-blog-post">
                            ...
                            <div class="nk-post-by">
                                <img src="src/assets/images/avatar-3.jpg" alt="Wolfenstein" class="rounded-circle" width="35"> by <a href="#">Wolfenstein</a> in Jul 23, 2018
                            </div>
                            <div class="nk-gap"></div>
                            <div class="nk-post-text">
                                <p>Just then her head struck against the roof of the hall: in fact she was now more than nine feet high, and she at once took up the little golden key and hurried off to the garden doorsrc.</p>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="nk-blog-post">
                            ...
                            <h2 class="nk-post-title h4"><a href="blog-article.php">At first, for some time, I was not able to answer</a></h2>
                            <div class="nk-post-by">
                                <img src="src/assets/images/avatar-3.jpg" alt="Wolfenstein" class="rounded-circle" width="35"> by <a href="#">Wolfenstein</a> in Jul 3, 2018
                            </div>
                            <div class="nk-gap"></div>
                            <div class="nk-post-text">
                                <p>This little wandering journey, without settled place of abode, had been so unpleasant to me, that my own house, as I called it to myself, was a perfect settlement to me compared to thatsrc.</p>
...
<div class="nk-blog-post nk-blog-post-border-bottom">
    <a href="blog-article.php" class="nk-post-img">
        <img src="src/assets/images/post-2-fw.jpg" alt="Grab your sword and fight the Horde">
    ...
    <h2 class="nk-post-title h4"><a href="blog-article.php">Grab your sword and fight the Horde</a></h2>
...
<div class="nk-blog-post nk-blog-post-border-bottom">
    <div class="row vertical-gap">
        <div class="col-lg-3 col-md-5">
            <a href="blog-article.php" class="nk-post-img">
                <img src="src/assets/images/post-7-mid-square.jpg" alt="At length one of them called out in a clear">
...
<div class="nk-blog-post nk-blog-post-border-bottom">
    <div class="row vertical-gap">
        <div class="col-lg-3 col-md-5">
            <a href="blog-article.php" class="nk-post-img">
                <img src="src/assets/images/post-9-mid-square.jpg" alt="He made his passenger captain of one">
...
<div class="nk-blog-post nk-blog-post-border-bottom">
    <a href="blog-article.php" class="nk-post-img">
        <img src="src/assets/images/post-1-fw.jpg" alt="Smell magic in the air. Or maybe barbecue">
    ...
    <div class="nk-gap-1"></div>
    <h2 class="nk-post-title h4"><a href="blog-article.php">Smell magic in the air. Or maybe barbecue</a></h2>
    <div class="nk-post-date mt-10 mb-10">
        <span class="fa fa-calendar"></span> Sep 18, 2018
...
<div class="nk-blog-post nk-blog-post-border-bottom">
    <div class="row vertical-gap">
        <div class="col-lg-3 col-md-5">
            <a href="blog-article.php" class="nk-post-img">
                <img src="src/assets/images/post-5-mid-square.jpg" alt="He made his passenger captain of one">
...
<div class="nk-blog-post nk-blog-post-border-bottom">
    <a href="blog-article.php" class="nk-post-img">
        <img src="src/assets/images/post-3-fw.jpg" alt="We found a witch! May we burn her?">
    ...
    <div class="nk-gap-1"></div>
    <h2 class="nk-post-title h4"><a href="blog-article.php">We found a witch! May we burn her?</a></h2>
    <div class="nk-post-date mt-10 mb-10">
...
<div class="nk-blog-post nk-blog-post-border-bottom">
    <div class="row vertical-gap">
        <div class="col-lg-3 col-md-5">
            <a href="blog-article.php" class="nk-post-img">
                <img src="src/assets/images/post-4-mid-square.jpg" alt="For good, too though, in consequence">
...
<div class="nk-blog-post nk-blog-post-border-bottom">
    <a href="blog-article.php" class="nk-post-img">
        <img src="src/assets/images/post-6-fw.jpg" alt="At first, for some time, I was not able to answer">
...
<div class="nk-blog-post nk-blog-post-border-bottom">
    <a href="blog-article.php" class="nk-post-img">
        <img src="src/assets/images/post-7-fw.jpg" alt="At length one of them called out in a clear">
...
<div class="nk-blog-post nk-blog-post-border-bottom">
    <div class="row vertical-gap">
        <div class="col-lg-3 col-md-5">
            <a href="blog-article.php" class="nk-post-img">
                <img src="src/assets/images/post-3-mid-square.jpg" alt="We found a witch! May we burn her?">
...
<div class="nk-blog-post nk-blog-post-border-bottom">
    <a href="blog-article.php" class="nk-post-img">
        <img src="src/assets/images/post-5-fw.jpg" alt="He made his passenger captain of one">
...
<div class="nk-widget nk-widget-highlighted">
    ...
    <div class="nk-widget-content">
            ...
            <div class="nk-widget-post">
                <a href="blog-article.php" class="nk-post-image">
                    <img src="src/assets/images/post-3-sm.jpg" alt="">
                </a>
